...
export const getServerSideProps = async ({ params }) => {
  const query = `*[type == 'order' && _id == '${params.id}']`;
      ...
      <Layout>
        <div className={css.container}>
          ...
          <div className={css.details}>
            ...
            <div>
              <span>Method</span>
              <span>{order.method ? "Cash on Delivery" : "Online"}</span>
            </div>
            <div>
              <span>Total</span>
          ...
          <div className={css.statusContainer}>
            ...
            <div className={css.status}>
              <img src={Cooking} alt="" width={50} height={50} />
              <span>Cooking</span>
            ...
            <div className={css.status}>
              <UilBox widthwidth={50} height={56} />
              <span>Delivered</span>
              {order.status === 3 && (
                <div className={css.spinner}>
                  <Image src={Spinner} alt="" width={50} height={50} />
